	...
	var Login = (function (_React$Component) {
	    ...
	    _createClass(Login, [{
	        ...
	        value: function subForm(e) {
	            e.preventDefault();
	            var user = _reactDom2.default.findDOMNode(this.refs.user);
	            console.log(user);
	            if (!user.value) {
	                this.setState({
	                    msg: '用户不能为空',
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    { onSubmit: function onSubmit(e) {
	                            return _this2.subForm(e);
	                        }, method: 'post' },
	                    _react2.default.createElement('input', { type: 'text', name: 'user', ref: 'user' }),
	                ...
	                _react2.default.createElement(_dialog2.default, { msg: this.state.msg, show: this.state.show })
	            );
	        }
	    }]);
